...
package com.muaedu.basis.customtimepicker.wheel;
...
import com.muaedu.basis.customtimepicker.R;
import com.muaedu.basis.customtimepicker.adapters.WheelViewAdapter;
import com.muaedu.basis.customtimepicker.config.DefaultConfig;
...
public class WheelView extends View {
     ...
     */
    private static final int ITEM_OFFSET_PERCENT = 16;
    ...
    private void initData(Context context) {
        ...
        mPaintLineCenter.setStrokeWidth(0);
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
        //宽度
        mPaintLineRight.setStrokeWidth(0);
